...
namespace APIVerve
{
    public class WordRhymesAPIClient
    {
        ...
        public WordRhymesAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public WordRhymesAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, wordrhymesQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(wordrhymesQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(wordrhymesQueryOptions options)
        {
